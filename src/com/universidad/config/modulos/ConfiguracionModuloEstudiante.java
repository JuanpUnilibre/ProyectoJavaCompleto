...
public class ConfiguracionModuloEstudiante
    ...
    public ConfiguracionModuloEstudiante() {
        ...
        TpaRepository<Estudiante, UUID> tpaEngine =
        ...
        EstudianteMapeador mapeador =
                new EstudianteMapeador();

        repositorio =
                new EstudianteRepositorioImpl(tpaEngine);

        servicio =
                new EstudianteServicio(
                        mapeador,
                        repositorio
                );
    }
    ...
    public SystemModule construirVista() {
        EstudianteControlador controlador =
                new EstudianteControlador(servicio);
